...
class ReviewList extends Component {
  ...
  submitReview = (event) => {
    ...
    // be aware in javascript you could have put just rating instead of rating:rating because javascript understands the value will be equal
    const newReview = {
      id: Number(new Date()),
      createDate: new Date(),
      rating: rating,
  ...
  render() {
    return (
      ...
      <form onSubmit={this.submitReview}>
        ...
        <div className="form-group">
            <textarea type="email" className="email" name="author" placeholder="Email" />
        </div>
